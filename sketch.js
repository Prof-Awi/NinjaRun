...
function preload(){
  ninjarunning = loadAnimation("png/Run__000.png","png/Run__001.png","png/Run__002.png","png/Run__003.png","png/Run__004.png","png/Run__005.png","png/Run__006.png","png/Run__007.png","png/Run__008.png","png/Run__009.png",)
  ninjaslide = loadAnimation("png/Slide__000.png","png/Slide__001.png","png/Slide__002.png","png/Slide__003.png","png/Slide__004.png","png/Slide__005.png","png/Slide__006.png","png/Slide__007.png","png/Slide__008.png","png/Slide__009.png",)
  ninjajump = loadAnimation("png/Jump__000.png","png/Jump__001.png","png/Jump__002.png","png/Jump__003.png","png/Jump__004.png","png/Jump__005.png","png/Jump__006.png","png/Jump__007.png","png/Jump__008.png","png/Jump__009.png",)
  ninjacut = loadAnimation("png/Attack__000.png","png/Attack__001.png","png/Attack__002.png","png/Attack__003.png","png/Attack__004.png","png/Attack__005.png","png/Attack__006.png","png/Attack__007.png","png/Attack__008.png","png/Attack__009.png",)
  ninjadead = loadAnimation("png/Dead__000.png","png/Dead__001.png","png/Dead__002.png","png/Dead__003.png","png/Dead__004.png","png/Dead__005.png","png/Dead__006.png","png/Dead__007.png","png/Dead__008.png","png/Dead__009.png",)
  obstacle1 = loadImage("png/obstacle1.png");
  obstacle2 = loadImage("png/obstacle2.png");
  obstacle3 = loadImage("png/obstacle3.png");
  obstacle4 = loadImage("png/obstacle4.png");
  obstacle5 = loadImage("png/obstacle5.png");
  bombimg = loadImage("png/bomb.png");
  resetimg = loadImage("png/reset.png");

}

function setup() {
  createCanvas(1153, 467);
  groundimg = loadImage("png/bg.jpeg")
  ...
  gamestate = PLAY
  reset = createSprite(576.5,233.5);
